  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: 'Contributing Conditions ICD-11', value: formData.contributing_conditions_icd_code },
      ],
    },
    {
